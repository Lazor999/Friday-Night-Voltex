...
class Achievements
{
	public static var achievementsStuff:Array<Dynamic> = [
		...
		[
			"The Bare Minimum",
			"Pass The First Week In Maximum Difficulty To Prove You Are A True Gamer",
			false
		],
		["Nice", "Get Less Than 69 Misses In Week1 in Maximum Difficulty", false],
		["Skill Issue", "Change Difficulty To Novice Mid Song (Lol, Skill Issue)", false],
		["IKADKNKNF IT'S A SCRETTTTTT!!!!!", "Pass ???", false] /*,
	...
	public static var achievementsUnlocked:Array<Dynamic> = [
		...
		['week1_pass', false], // 0
		['week1_less_than_69_misses', false], // 1
		['noob', false], // 2
		['battleblock_reference', false] /*,		//3
