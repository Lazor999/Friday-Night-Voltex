...
class ChartingState extends MusicBeatState
{
	...
	var eventStuff:Array<Dynamic> = [
		...
		[
			'Combro told me to change the name of this event or else we will get canceled',
			"Value1: 0 = invisible 1 = visible no spin 2 = visible and spin"
		],
		['Shut Off', "i feel empty, pls kill meeeeeeeeeeeeeeeeee"],
		['Shut Off2', "gfsfhdfhdfgdfhdfhdfhdf"]
	];
